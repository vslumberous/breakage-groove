...
diameter2 = st.selectbox("Fastener Diameter", list(unc_sizes.keys()), key="joint2_diameter")
tpi2 = st.number_input("Threads per Inch (TPI)", value=13, step=1, key="joint2_tpi")
quantity2 = st.number_input("Number of Fasteners", value=1, step=1, key="joint2_quantity")
grade2 = st.selectbox("Fastener Grade", list(fastener_grades.keys()), key="joint2_grade")
torque2 = st.number_input("Torque (ft-lb)", value=0, step=1, key="joint2_torque")
